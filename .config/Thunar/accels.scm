...
(gtk_accel_path "<Actions>/ThunarActions/uca-action-1735604079977506-1" "<Primary>Return")
...
(gtk_accel_path "<Actions>/ThunarWindow/toggle-image-preview" "<Primary><Shift>h")
